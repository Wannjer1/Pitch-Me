...
Revision ID: c0d628b8e300
Revises: 
Create Date: 2022-05-17 18:46:01.759283
...
def upgrade():
    ...
    sa.Column('mainuser_id', sa.Integer(), nullable=True),
    sa.Column('description', sa.Text(), nullable=True),
    sa.ForeignKeyConstraint(['mainuser_id'], ['users.id'], ),
