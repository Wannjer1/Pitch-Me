...
class Pitch(db.Model):
    ...
    comments_id = db.relationship('Comment',backref='pitch',lazy='dynamic')
    upvotes_id = db.relationship('Upvote', backref = 'pitch', lazy = 'dynamic')
    downvotes_id = db.relationship('Downvote', backref = 'pitch', lazy = 'dynamic')
...
class Comment(db.Model):
    ...
    mainuser_id = db.Column(db.Integer, db.ForeignKey('users.id'))
